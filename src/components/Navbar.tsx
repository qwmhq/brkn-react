...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-[#333] py-4 px-[--edge-gap] uppercase text-xs flex items-center justify-between">
          ...
          >
            <PopoverAnchor asChild>
              <input
                ...
                className="w-48 py-1 px-0 text-white placeholder-[#6a6868] bg-transparent border-b border-b-white outline-none"
              />
            </PopoverAnchor>
            <PopoverContent
        ...
        <ul className="flex flex-shrink flex-grow basis-auto justify-center list-none gap-8 text-white placeholder-[#6a6868]">
          <li>
            <Link to="/">Home</Link>
          </li>
